...
echo "Starting configuration of Curiosity Microservices!"
...
kubectl apply -f curiosityms-namespace.yaml
...
create secret generic curiosityms-mysql-db-secret \ 
...
kubectl apply -f ./appconfig/curiosityms-service-clusterip.yaml
kubectl apply -f ./appconfig/curiosityms-configmap.yaml
kubectl describe configmap curiosityms-configmap -n curiosityevents
kubectl apply -f  ./appconfig/curiosityms-deployment.yaml -n curiosityevents
